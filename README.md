...
Shift+F2 (внизу FF откроется поле ввода) > печатай "rst" без кавычек > Tab > Enter<br>
Ещё можно напечатать "rest", но зачем?<br>
...
**Всегда в зашифрованном виде**, как blob объекты ([алгоритм 3des](https://ru.wikipedia.org/wiki/Triple_DES)), <br>
...
при установке которого добавляется "соль" в key3.db - тогда расшифровать logins.json без знания Мастер-пароля не получится. <br>
