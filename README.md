...
* [Как быстро найти нужную вкладку когда их слишком много](#Как-быстро-найти-нужную-вкладку-когда-их-слишком-много)
___
...
UPD: после FF 62+ Developer Toolbar убрали <br>
https://www.ghacks.net/2018/05/21/firefox-62-developer-toolbar-removal/ <br>
В связи с этим, способ номер джва: открыть страницу `about:restartrequired` и нажать на кнопку.<br>
